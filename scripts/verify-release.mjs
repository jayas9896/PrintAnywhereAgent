...
const textChecks = [
  ...
  },
  {
    ...
    mustInclude: [
      ...
      // KAN-165: opens the HTTPS console and honours the launcher config.
      'https://',
      'ui-launcher.json',
      'ui-runtime.json',
    ],
    mustNotInclude: ['Start-Process "http://127.0.0.1'],
  },
  {
    file: 'scripts/lib/local-https-setup.ps1',
    mustInclude: [
      'Install-LocalHttpsUi',
      'Uninstall-LocalHttpsUi',
      'certutil',
      'local.printanywhere.dhruvantasystems.com',
    ],
    mustNotInclude: [],
  },
  {
